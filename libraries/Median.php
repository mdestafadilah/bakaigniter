...
class Median
{
    ...
    public function __construct(array $configs = array())
    {
        ...
        log_message('debug', "#BakaIgniter: Median Class Initialized");
    }
    ...
    public function do_upload()
    {
        if (isset($_FILES[$this->field_name]))
        {
            ...
            if ($this->_ci->upload->do_upload($this->field_name))
            {
                ...
                log_message('debug', '#BakaIgniter: Media->do_upload file "'.$uploaded_data['orig_name'].'" uploaded successfuly.');
                ...
                if ($this->is_image($uploaded_data['file_type']))
                {
                    ...
                    if ($this->_ci->image_lib->resize())
                    {
                        ...
                        log_message('debug', '#BakaIgniter: Media->do_upload file "'.$uploaded_data['orig_name'].'" has been resized.');
                    }
                }
